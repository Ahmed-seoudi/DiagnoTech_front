  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      successDiv.className =
        "alert alert-success position-fixed top-0 start-50 translate-middle-x mt-4 shadow-lg";
    ...
    <Container className="mt-5">
      <Row className="mb-4 gx-4">
        <Col lg={8}>
          ...
          <Card
            className="mb-4 shadow-lg border-0 rounded-3"
            ...
            <Card.Body className="p-4">
              <Row>
                <Col md={4} className="text-center mb-4 mb-md-0">
                  ...
                  <h5 className="fw-bold text-primary mt-3">
                    {userData.fullName}
                  </h5>
          ...
          {/* Action Buttons Card */}
          <Card
            className="shadow-lg border-0 rounded-3 mb-4"
            style={{ backgroundColor: "#f8f9fa" }}>
            <Card.Body className="p-4">
              ...
              {medicalHistory.length ? (
                <div
                  ...
                  {medicalHistory.slice(0, visibleCount).map((item, index) => {
                    ...
                    const disease =
                      item.diagnosisResult?.[0]?.disease || "Unknown Disease";
                        ...
                        <Card.Body className="py-3 px-3">
                          <div className="d-flex justify-content-between align-items-center">
                            <div>
                              ...
                              <p
                                ...
                                <BsCalendarDate className="me-1" size={12} />{" "}
                          ...
                          {isOpen && (
                            <div
                              ...
                              {item.diagnosisResult?.[0]?.precautions?.length >
                                0 && (
                                <div>
                                  <h6 className="fw-bold mb-2">
                                    <BsShieldCheck
                                  ...
                                  <ul className="ps-4 mb-0">
                                    {item.diagnosisResult[0].precautions.map(
                                      (p, idx) => (
                                        <li key={idx}>{p}</li>
                                      )
                                    )}
                              ...
                              <br />
                              {item.diagnosisResult?.[0]?.description?.length >
                                0 && (
                                <div>
                                  <h6 className="fw-bold mb-2">
                                    <BsClipboard2Fill
                                  ...
                                  <p className="ps-4 mb-0">
                                    {item.diagnosisResult[0].description}
                                  </p>
                                </div>
                              )}
                            </div>
      ...
      <Modal
        ...
        <Modal.Header closeButton className="bg-light py-3">
          <Modal.Title className="text-danger" style={{ fontSize: "1.2rem" }}>
        ...
        <Modal.Footer className="py-3">
          ...
          <p className="warning-delete">
            If you click Delete, your account will be deleted immediately.
          </p>
        </Modal.Footer>
      </Modal>
